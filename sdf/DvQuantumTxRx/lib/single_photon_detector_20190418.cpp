	...
	else
	{
		...
		case signal_value_type::t_photon_mp_xy:
			for (auto k = 0; k < process; k++) {
				...
				nThisDetector = (nThisDetector > 0.0022) ? nThisDetector : 0;
				nOtherDetector = (nOtherDetector > 0.0022) ? nOtherDetector : 0;
...
//				double probabilityOfThisDetectorClick = nThisDetector*efficiency/2;
				...
				double probabilityOfTheOtherDetectorClick = 1 - exp(-nOtherDetector);

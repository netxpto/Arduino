...
enum class signal_value_type { t_binary, t_sequence, t_integer, t_real, t_complex, t_complex_xy, t_photon, t_photon_mp, t_photon_mp_xy, t_iqValues, t_message };
	...
	void setBuffer() {
		...
		switch (sType) {
			...
			case signal_type::TimeDiscreteAmplitudeContinuousReal:
				...
				break;
			case signal_type::TimeDiscreteAmplitudeDiscreteReal:
				typeName = "TimeDiscreteAmplitudeDiscreteReal";
				break;
...
public:
	...
	void setLogFileName(string lFileName) { logFileName = lFileName; };

	void setSignalsFolderName(string sFolderName) { signalsFolderName = sFolderName; };
	string getSignalsFolderName() { return signalsFolderName; };
...
private:
	...
	string signalsFolderName{ "signals" };

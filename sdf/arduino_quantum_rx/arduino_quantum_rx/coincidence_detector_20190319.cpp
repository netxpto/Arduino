...
CoincidenceDetector::~CoincidenceDetector() {
  ...
  Serial.print("Number of Bits sent by Alice: ");
  Serial.println(bitsAlice);
  Serial.print("Number of Bits received by Bob: ");
  Serial.println(bitsAlice - bitsAtten - bitsDoubl);
  Serial.print("Number of Bits double click: ");
  Serial.println(bitsDoubl);
  Serial.print("Number of Bits that suffered attenuation: ");
  Serial.println(bitsAtten);

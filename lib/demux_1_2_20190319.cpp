...
bool Demux_1_2::runBlock(void) {
	...
	*/
	if ((inSignalType1 == signal_value_type::t_binary) && (inSignalType2 == signal_value_type::t_binary)) {
		t_binary binValue;
	...
	else if ((inSignalType1 == signal_value_type::t_real) && (inSignalType2 == signal_value_type::t_binary)) {
		t_real binValue;
		t_binary logicalValue;

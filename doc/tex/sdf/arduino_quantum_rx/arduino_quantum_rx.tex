...
\begin{itemize}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.6\linewidth]{./sdf/arduino_quantum_rx/figures/Iptunnel.JPG}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\linewidth]{./sdf/arduino_quantum_rx/figures/tunel2.PNG}
	\caption{Signal the client is sending through the IPTunnel block and what the server is receiving.}
	\label{fig:arduino}
\end{figure}
\end{itemize}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\linewidth]{./sdf/arduino_quantum_rx/figures/DiagramaGeralard.pdf}

...
\end{itemize}
	...
	Since it is possible to control the TTL signal voltage that comes from the single photon detectors, we can measure them directly into the arduino board through the digital input pins.
	...
	This signal was read with the arduino, which has a 12 bit adc, and we obtain the following result in figure 5.12 . 
